...
{{ context.max_iterations }}     # Configured max, or empty string if unlimited
```

- Resolved automatically — no frontmatter configuration needed
- Useful for giving the agent awareness of its own identity and loop progress
