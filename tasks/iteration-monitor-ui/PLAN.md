...
- [x] 4. Polish run summary line — improve the `Done:` line formatting to match the iteration style (icons, alignment)
- [x] 5. Run full test suite and fix any broken assertions
